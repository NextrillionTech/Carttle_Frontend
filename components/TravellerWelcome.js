...
const TravellerWelcome = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Have a great traveling experience,{'\n'} Bon Voyage!!</Text>
      <View style={styles.buttonContainer}>
        <Animated.View style={{ ...styles.buttonWrapper, opacity: travelerOpacity }}>
          <TouchableOpacity style={styles.button} onPress={handleTravelerPress}>
            <Text style={styles.buttonText}>Create Account</Text>
          </TouchableOpacity>
        </Animated.View>
        <Animated.View style={{ ...styles.buttonWrapper, opacity: driverOpacity }}>
